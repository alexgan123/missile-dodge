...
switch(obj_game_manager.level) {
	...
	case 4: {
		...
		if t(32) {spawn_missile_regular_fixed(0, 0, random_range(0.05, 0.95))
			...
			spawn_missile_regular_fixed(0, 0, random_range(0.05, 0.95))
			spawn_powerup(powerupType.life, 0.2, 0.2)}
		...
		if t(59) {spawn_missile_exploding_left(0) spawn_powerup(powerupType.shield, 0.75, 0.75)}
		...
		if t(69) {spawn_missile_exploding_left(1)}
		...
		if t(78) {spawn_missile_regular_left(1) spawn_powerup(powerupType.regen, 0.25, 0.8)}
		if t(79) {spawn_missile_regular_right(1)}
		...
		if t(92) {spawn_missile_regular_fixed(0, 0, 0.3) spawn_missile_regular_right(0) spawn_powerup(powerupType.shield, 0.2, 0.2) spawn_coin(0.75, 0.75)}
		...
		if t(104) {spawn_missile_regular_fixed(0, 0, 0.3) spawn_powerup(powerupType.regen, 0.25, 0.75)}
	...
	case 5: {
		...
		if t(57) {spawn_missile_regular_bottom(0)} if t(57.5) {spawn_missile_regular_bottom(0)} if t(58) {spawn_missile_regular_bottom(0) spawn_powerup(powerupType.life, 0.8, 0.8)} 
		...
		if t(65) {spawn_missile_speedy_fixed(1, 0, 0.3) spawn_missile_regular_top(1)}
		...
		if t(74) {spawn_missile_speedy_fixed(1, 1, 0.7) spawn_missile_regular_bottom(1)}
		...
		if t(103) {spawn_missile_exploding_fixed(0, 1, 0.5) spawn_coin(0.3, 0.3)}
	...
	case 6: {
		...
		if t(32) {spawn_missile_speedy_right(1)}
		...
		if t(43) {spawn_powerup(powerupType.shield, 0.2, 0.2) spawn_missile_regular_fixed(0, 0, random_range(0.1, 0.5)) spawn_missile_regular_fixed(0, 0, random_range(0.5, 0.9))}
		...
		if t(59) {spawn_powerup(powerupType.regen, 0.2, 0.8) spawn_missile_small_fixed(1, 0.5, 0)}
		...
		if t(68) {spawn_missile_small_fixed(1, 1, 0.5) spawn_missile_regular_left(0)}
		...
		if t(83) {spawn_powerup(powerupType.life, 0.8, 0.8) spawn_missile_scatter(0, 1, 0.7)}
		...
		if t(97) {spawn_missile_regular_bottom(0) spawn_powerup(powerupType.regen, 0.2, 0.2) 
		...
		if t(102) {spawn_powerup(powerupType.shield, 0.8, 0.2) spawn_missile_regular_left(2) spawn_missile_regular_right(2)}
